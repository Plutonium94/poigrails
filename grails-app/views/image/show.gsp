	...
	<body>
		...
		<div id="show-image" class="content scaffold-show" role="main">
			...
			<ol class="property-list image">
				...
				<g:if test="${imageInstance?.titre}">
				<li class="fieldcontain">
					<span id="titre-label" class="property-label"><g:message code="image.titre.label" default="Titre" /></span>
					
						<span class="property-value" aria-labelledby="titre-label"><g:fieldValue bean="${imageInstance}" field="titre"/></span>
